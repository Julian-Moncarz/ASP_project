#!/usr/bin/env python3
"""
Original SLEEC to Clingo Converter Entry Script
==============================================

Converts SLEEC files to Clingo format using the original direct rule translation approach.

Usage:
    python original_converter.py <input.sleec> [output.lp]
...
from converters import SleecToClingoConverter
...
def main():
    ...
    if len(sys.argv) >= 3:
        ...
        # Replace .sleec with _original.lp
        input_path = Path(input_file)
        output_file = str(input_path.with_name(input_path.stem + '_original.lp'))
